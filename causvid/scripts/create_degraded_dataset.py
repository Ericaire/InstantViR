...
try:
    from causvid.models.wan.causal_inference import InferencePipeline  # heavy, may require flash-attn
    _HAS_PIPELINE = True
except Exception:
    InferencePipeline = None
    _HAS_PIPELINE = False
from causvid.ode_data.create_lmdb_iterative import store_arrays_to_lmdb, get_array_shape_from_lmdb, retrieve_row_from_lmdb
